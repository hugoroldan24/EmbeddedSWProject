...
#define NUM_ELEMENTS    2      /* Number of motors to control */
...
#define AUTO_TRIGGER_TIME    3000              /* Time between ADC conversions (µs) */
...
#define DD_INT0            DDD2     /* Data direction: INT0 pin */
